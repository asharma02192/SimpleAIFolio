...
async function seed() {
  ...
  if (!admin) {
    ...
    admin = await prisma.user.create({
      data: { email: "admin@myplweb.com", password: hashed, name: "Admin" },
    });
    console.log("Seed: Admin created — email: admin@myplweb.com, password: admin123");
  }
  ...
  console.log("Seed: Complete! Login with admin@myplweb.com / admin123");
}
